...
```{r}
wav_field_filt <- ffilter(wav_field, 
                          bandpass = TRUE, 
                          from = 2000, # Low-frequency limit
                          to = 4000,   # High-frequency limit
                          output = "Wave")
oscillo(wav_field_filt, fastdisp = TRUE)
```
